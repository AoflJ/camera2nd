<?php 
    ...
    $sql = "SELECT * From products Where (	product_types_id = '2') and (brand_id = '4')";
            ...
            <div class="col-md-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Mirrorless</li>
                        <li class="breadcrumb-item active" aria-current="page">fuji</li>
                    </ol>
                </nav>
